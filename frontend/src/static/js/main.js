...
//         if (!eventId) {
//             alert("Event ID not found. Please upload an event first.");
//             return;
//         }
...
//                 // Optionally, show the share link once processing completes
//                 shareLink.value = `${window.location.origin}/gallery/${data.event_id}`;
...
//             alert("An error occurred while starting face processing.");
//         } finally {
//             // Hide the loader
...
//                 generateBtn.setAttribute('data-event-id', data.event_id); // Store event ID for Generate button
//             } else {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //     const eventId = generateBtn.getAttribute('data-event-id');
    //     if (!eventId) {
    //         alert("Event ID not found. Using the latest event.");
    //         return;
    //     }
