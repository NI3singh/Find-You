...
//                 <img src="/api/photo/${photo.id}" alt="Event photo">
//                 <div class="photo-actions">
//                     <button onclick="downloadPhoto('${photo.id}', '${photo.filename}')">
//                         Download
//                     </button>
//                 </div>
//             </div>
...
//         try {
//             const response = await fetch(`/api/photo/${photoId}/download`);
...
//         try {
//             const resultId = getResultIdFromUrl();
//             const response = await fetch(`/api/find_photos/${resultId}`);
...
//         photosGrid.innerHTML = photos.map(photo => `
//             <div class="photo-item">
//                 <img src="/api/photo/${encodeURIComponent(photo)}" alt="Matched photo">
//                 <div class="photo-actions">
...
//     window.downloadPhoto = async (photoPath) => {
//         try {
//             const response = await fetch(`/api/photo/${encodeURIComponent(photoPath)}`);
//             const blob = await response.blob();
//             const url = window.URL.createObjectURL(blob);
//             const a = document.createElement('a');
//             a.href = url;
//             a.download = photoPath.split('/').pop();
//             document.body.appendChild(a);
//             a.click();
//             window.URL.revokeObjectURL(url);
//             document.body.removeChild(a);
...
//     downloadAllBtn.addEventListener('click', async () => {
//         try {
//             const photos = Array.from(document.querySelectorAll('.photo-item img')).map(img => img.src);
//             const response = await fetch('/api/photos/download', {
//                 method: 'POST',
//                 headers: {
//                     'Content-Type': 'application/json',
//                 },
//                 body: JSON.stringify({ photo_paths: photos }),
//             });
...
//         photosGrid.innerHTML = photos.map(photo => `
//             <div class="photo-item">
//                 <img src="/uploads/${photo}" alt="Matched photo">
//                 <div class="photo-actions">
//                     <button onclick="downloadPhoto('${photo}')">Download</button>
//                 </div>
//             </div>
...
//     window.downloadPhoto = async (photoPath) => {
//         try {
//             const response = await fetch(`/api/photo/${encodeURIComponent(photoPath)}/download`);
//             const blob = await response.blob();
//             const url = window.URL.createObjectURL(blob);
//             const a = document.createElement('a');
//             a.href = url;
